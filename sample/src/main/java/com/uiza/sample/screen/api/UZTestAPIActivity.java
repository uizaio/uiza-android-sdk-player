package com.uiza.sample.screen.api;
...
public class UZTestAPIActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getListMetadata() {
        ...
        UzApiMaster.getInstance()
                .subscribe(
                        service.getListMetadata(UzPlayerData.getInstance().getApiVersion(), 100, 1),
    ...
    private void searchAnEntity() {
        ...
        UzApiMaster.getInstance()
                .subscribe(
                        service.searchEntity(UzPlayerData.getInstance().getApiVersion(), keyword),
                        new ApiSubscriber<BasePaginationResponse<List<VideoData>>>() {
                            @Override
                            public void onSuccess(
                                    BasePaginationResponse<List<VideoData>> response) {
    ...
    private void getTimeStartLive() {
        ...
        UzApiMaster.getInstance().subscribe(
                service.getTimeStartLive(UzPlayerData.getInstance().getApiVersion(), entityId,
                        feedId,
                        UzPlayerData.getInstance().getAppId()),
                new ApiSubscriber<BaseResponse<VideoData>>() {
                    @Override
    ...
    private void getIMAAd() {
        ...
        UzApiMaster.getInstance().subscribe(
                service.getCuePoint(UzPlayerData.getInstance().getApiVersion(),
                        "0e8254fa-afa1-491f-849b-5aa8bc7cce52",
                        UzPlayerData.getInstance().getAppId()),
