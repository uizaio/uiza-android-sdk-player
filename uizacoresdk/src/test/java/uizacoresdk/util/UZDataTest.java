...
@PrepareForTest({UZRestClient.class, UZRestClientGetLinkPlay.class, UZRestClientHeartBeat.class,
        UZRestClientTracking.class, UZUtil.class, Utils.class, Loitp.class, TmpParamData.class,
        LDateUtils.class})
public class UZDataTest {

    @Before
    public void setup() {
        PowerMockito.mockStatic(UZRestClient.class, UZRestClientGetLinkPlay.class, UZRestClientHeartBeat.class,
                UZRestClientTracking.class, UZUtil.class, Utils.class, Loitp.class, TmpParamData.class,
                LDateUtils.class);
    }
    ...
    public void initSDK_DEV_success() {
        ...
        UZData.getInstance().initSDK(domain, token, appId, Constants.ENVIRONMENT_DEV);
    ...
    public void initSDK_STG_success() {
        ...
        UZData.getInstance().initSDK(domain, token, appId, Constants.ENVIRONMENT_STAG);
    ...
    public void initSDK_PRO_success() {
        ...
        UZData.getInstance().initSDK(domain, token, appId, Constants.ENVIRONMENT_PROD);
    ...
    public void initSDK_wrongDomain_failed() {
        ...
        for (String domain : invalidDomains) {
            assertFalse(UZData.getInstance().initSDK(domain, token, appId, Constants.ENVIRONMENT_PROD));
        }
    }
    ...
    public void createTrackingInput_Success() {
        ...
        when(Loitp.getDeviceId(mockContext)).thenReturn(fakeDeviceId);
        ...
        when(UZData.getInstance().createTrackingInput(mockContext, playThrough, eventType)).thenCallRealMethod();
        UizaTracking uizaTracking = UZData.getInstance().createTrackingInput(mockContext, playThrough, eventType);
