...
typedef void (*x264_predict_8x8_filter_t)(pixel *src, pixel edge[36], int i_neighbor,
                                          int i_filters);
...
void
x264_predict_8x8_init(int cpu, x264_predict8x8_t pf[12], x264_predict_8x8_filter_t *predict_filter);
