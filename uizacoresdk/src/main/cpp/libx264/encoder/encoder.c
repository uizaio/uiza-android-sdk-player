...
static int x264_validate_parameters(x264_t *h, int b_open) {
    ...
    if (i_csp <= X264_CSP_NONE || i_csp >= X264_CSP_MAX) {
        x264_log(h, X264_LOG_ERROR,
                 "invalid CSP (only I420/YV12/NV12/NV21/I422/YV16/NV16/YUYV/UYVY/"
...
x264_bitstream_backup(x264_t *h, x264_bs_bak_t *bak, int i_skip, int full) {
    if (full) {
...
static ALWAYS_INLINE void
x264_bitstream_restore(x264_t *h, x264_bs_bak_t *bak, int *skip, int full) {
    if (full) {
