...
enum {
    ...
    AVS_CS_PLANAR_MASK =
    AVS_CS_PLANAR | AVS_CS_INTERLEAVED | AVS_CS_YUV | AVS_CS_BGR | AVS_CS_SAMPLE_BITS_MASK |
...
enum {
    ...
    AVS_CS_SUB_WIDTH_1,  // YVU 4:4:4 planar
    AVS_CS_YV16 =
    AVS_CS_PLANAR | AVS_CS_YUV | AVS_CS_SAMPLE_BITS_8 | AVS_CS_VPLANEFIRST | AVS_CS_SUB_HEIGHT_1 |
    AVS_CS_SUB_WIDTH_2,  // YVU 4:2:2 planar
    AVS_CS_YV12 =
    AVS_CS_PLANAR | AVS_CS_YUV | AVS_CS_SAMPLE_BITS_8 | AVS_CS_VPLANEFIRST | AVS_CS_SUB_HEIGHT_2 |
    AVS_CS_SUB_WIDTH_2,  // YVU 4:2:0 planar
    AVS_CS_I420 =
    ...
    AVS_CS_Y8 = AVS_CS_PLANAR | AVS_CS_INTERLEAVED | AVS_CS_YUV |
                AVS_CS_SAMPLE_BITS_8                                              // Y   4:0:0 planar
};
...
AVSC_INLINE int avs_row_size(const AVS_VideoInfo *p) { return avs_row_size_p(p, 0); }
