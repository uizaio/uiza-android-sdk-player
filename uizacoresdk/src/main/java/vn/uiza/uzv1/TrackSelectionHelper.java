...
import vn.uiza.uzv1.view.util.DemoUtilV1;
    ...
    private View buildView(Activity activity, String msg) {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                //trackView.setText(DemoUtilV1.buildTrackName(group.getFormat(trackIndex)));
                trackView.setText(DemoUtilV1.buildShortTrackName(group.getFormat(trackIndex)));
