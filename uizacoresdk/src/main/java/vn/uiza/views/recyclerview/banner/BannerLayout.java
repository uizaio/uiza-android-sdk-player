package vn.uiza.views.recyclerview.banner;
...
import loitp.core.R;
import vn.uiza.views.recyclerview.banner.layoutmanager.BannerLayoutManager;
import vn.uiza.views.recyclerview.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        showIndicator = a.getBoolean(R.styleable.BannerLayout_showIndicator_banner_layout, true);
