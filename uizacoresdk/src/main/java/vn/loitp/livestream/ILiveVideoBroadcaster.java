...
/**
 * Created by loitp on 29/03/2017.
 */
...
public interface ILiveVideoBroadcaster {
     ...
     *
     * @param activity the activity which is using this service
     * @param mGLView  the GLSurfaceView which is used to render camera view
     */
