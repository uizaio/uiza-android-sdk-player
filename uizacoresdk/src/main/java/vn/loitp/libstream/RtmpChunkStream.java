...
public class RtmpChunkStream {
    ...
    int processChunk(ByteBuffer buffer) {
        ...
        if (this.new_chunk) {
            ...
            LLog.d("RtmpChunkStream", "fmt=" + reply_to_client);
            ...
            LLog.d("RtmpChunkStream", "message_length=" + this.message_length);
        ...
        if (available_payload1 == 0) {
            ...
            try {
                ...
                LLog.e("RtmpChunkStream", Log.getStackTraceString(var9));
                return 2;
            }
        ...
        if (this.message_length != 6) {
            ...
            if (type == 6) {
                ...
                try {
                    ...
                    LLog.e("RtmpChunkStream", Log.getStackTraceString(var6));
                    return false;
                }
