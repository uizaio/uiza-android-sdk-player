...
class CameraManager21 extends CameraManager {
    ...
    List getCameraList(Context context) {
        ...
        try {
            ...
            LLog.e("CameraManager21", Log.getStackTraceString(var10));
            return null;
        }
    }
    ...
    Streamer.CameraInfo getCameraInfo(Context context, String cameraId) {
        ...
        try {
            ...
            for (int fpsRanges = 0; fpsRanges < previewSizes.length; ++fpsRanges) {
                LLog.d("", " " + previewSizes[fpsRanges].getWidth() + "x" + previewSizes[fpsRanges].getHeight());
            ...
            LLog.e("CameraManager21", Log.getStackTraceString(var12));
            return null;
        }
    }
}
