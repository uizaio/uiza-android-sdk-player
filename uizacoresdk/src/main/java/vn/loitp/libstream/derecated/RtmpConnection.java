...
public class RtmpConnection extends BaseConnection {
    ...
    RtmpConnection(ConnectionManager connectionManager, int connectionId, Streamer.MODE mode, String uri, String host, int port, String app, String stream, Streamer.Listener listener) throws IOException {
        ...
        this.RTMP_PUBLISH_CHUNK_SIZE = 262144;
        ...
        LLog.d("RtmpConnection", "RtmpConnection");
    ...
    void success_command_response(double transactionId, double aux) {
        LLog.d("RtmpConnection", "success_command_response");
        switch ((int) transactionId) {
            case -1:
    ...
    void sendHandshakeC0C1() {
        LLog.d("RtmpConnection", "sendHandshakeC0C1");
        ...
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var6));
            this.Close();
        }
    ...
    void sendHandshakeC2(byte[] handshakeS0) {
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var3));
            this.Close();
        }
    ...
    void sendSetChunkSize(int chunk_size) {
        LLog.d("RtmpConnection", "sendSetChunkSize");
        ...
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var4));
            this.Close();
        }
    ...
    void sendConnect() {
        LLog.d("RtmpConnection", "sendConnect");
        ...
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var5));
            this.Close();
        }
    ...
    void sendCreateStream() {
        LLog.d("RtmpConnection", "sendCreateStream");
    ...
    void sendPublish() {
        LLog.d("RtmpConnection", "sendPublish");
    ...
    void onConnect() {
        LLog.d("RtmpConnection", "onConnect");
        ...
        switch (RtmpConnection.NamelessClass1594666098.$SwitchMap$com$wmspanel$libstream$RtmpConnection$RTMP_CONNECTION_STATE[this.state_.ordinal()]) {
            case 1:
                ...
                if (byteBuffer.array()[0] != 3) {
                    LLog.e("RtmpConnection", "Invalid protocol version: " + byteBuffer.array()[0]);
                    this.Close();
                    return 0;
                }
        ...
        switch (RtmpConnection.NamelessClass1594666098.$SwitchMap$com$wmspanel$libstream$RtmpConnection$RTMP_CONNECTION_STATE[this.state_.ordinal()]) {
            ...
            case 6:
                while (this.avc_part_offset < this.currentItem_.getData().length) {
                    ...
                    if (part_len <= 0) {
                        LLog.e("RtmpConnection", "failed to send video part");
                        return;
                    }
    ...
    boolean sendAcknowledgement(int acknoledgement) {
        LLog.d("RtmpConnection", "sendAcknowledgement");
        byte[] header = new byte[12];
        header[0] = 2;
        header[6] = 4;
        header[7] = 3;
    ...
    ByteBuffer createH264ConfigRecord(byte[] sps, byte[] pps) {
        if (sps.length < 4) {
            LLog.e("RtmpConnection", "sps must be at least 4 bytes long");
            return null;
        } else {
    ...
    void sendMetaData() {
        LLog.d("RtmpConnection", "sendMetaData");
        ...
        try {
            ...
            if (this.mode_ == Streamer.MODE.VIDEO_ONLY || this.mode_ == Streamer.MODE.AUDIO_VIDEO) {
                ...
                if (null == this.videoFormatParams_) {
                    LLog.e("RtmpConnection", "failed to get avc params");
                    this.Close();
                    return;
                }
                ...
                if (null == rtmp_header_len) {
                    LLog.e("RtmpConnection", "failed to get sps info");
                    this.Close();
                    return;
                }

                LLog.d("RtmpConnection", "from sps: width=" + rtmp_header_len.width + ";height=" + rtmp_header_len.height);
    ...
    void sendAvcHeader() {
        LLog.d("RtmpConnection", "sendAvcHeader");
    ...
    void sendAacHeader() {
        LLog.d("RtmpConnection", "sendAacHeader");
        ...
        try {
            ...
            if (null == this.audioFormatParams_) {
                LLog.e("RtmpConnection", "failed to get aac params");
                this.Close();
                return;
            }
    ...
    void sendVideoFrameHeader(BufferItem item) {
        LLog.d("RtmpConnection", "sendVideoFrameHeader id=" + item.getMessageIndex());
        ...
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var12));
            this.Close();
        }
    ...
    private int sendVideoPart(BufferItem item, int offset) {
        LLog.v("RtmpConnection", "sendVideoPart id=" + item.getMessageIndex() + ";offset=" + offset + "; len=" + item.getData().length);
    ...
    void sendAudioFrame(BufferItem item) {
        LLog.v("RtmpConnection", "sendAudioFrame id=" + item.getMessageIndex());
        ...
        try {
            ...
            LLog.e("RtmpConnection", Log.getStackTraceString(var7));
            this.Close();
        }
        ...
        while (this.getSendBufferRemaining() <= 0) {
            ...
            switch (RtmpConnection.NamelessClass1594666098.$SwitchMap$com$wmspanel$libstream$BufferItem$FRAME_TYPE[this.currentItem_.getMessageType().ordinal()]) {
                ...
                case 2:
                    ...
                    break;
                default:
                    LLog.e("RtmpConnection", "unsupported frame type " + this.currentItem_.getMessageType());
            }
        }
