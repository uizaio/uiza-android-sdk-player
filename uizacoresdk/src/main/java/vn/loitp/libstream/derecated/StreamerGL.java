...
public class StreamerGL extends Streamer {
    ...
    public void setDisplayRotation(int r) {
        ...
        if (null != this.mVideoListener) {
            LLog.d("StreamerGL", "display rotation is " + Integer.toString(this.displayOrientation));
    ...
    public void setVideoOrientation(int o) {
        ...
        if (null != this.mVideoListener) {
            LLog.d("StreamerGL", "video rotation is " + Integer.toString(this.videoOrientation));
    ...
    public void startAudioCapture() {
        LLog.d("StreamerGL", "startAudioCapture");
    ...
    public void startVideoCapture() {
        LLog.d("StreamerGL", "startVideoCapture");
        if (null == this.mVideoListener) {
