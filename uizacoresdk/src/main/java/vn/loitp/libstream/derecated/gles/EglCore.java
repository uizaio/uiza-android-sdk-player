...
public final class EglCore {
        ...
        if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
            ...
            if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
                ...
                if (!EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
                    ...
                    LLog.d("Grafika", "EGLContext created, client version " + values1[0]);
                }
            }
        }
    }
    ...
    public static void logCurrent(String msg) {
        ...
        LLog.d("Grafika", "Current EGL (" + msg + "): display=" + display + ", context=" + context + ", surface=" + surface);
    }
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        if (!EGL14.eglChooseConfig(this.mEGLDisplay, attribList, 0, configs, 0, configs.length, numConfigs, 0)) {
            LLog.d("Grafika", "unable to find RGB8888 / " + version + " EGLConfig");
            return null;
        } else {
            return configs[0];
        }
    ...
    protected void finalize() throws Throwable {
        try {
            if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                LLog.d("Grafika", "WARNING: EglCore was not explicitly released -- state may be leaked");
                this.release();
            }
        } finally {
            super.finalize();
    ...
    public void makeCurrent(EGLSurface eglSurface) {
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            LLog.d("Grafika", "NOTE: makeCurrent w/o display");
        }
