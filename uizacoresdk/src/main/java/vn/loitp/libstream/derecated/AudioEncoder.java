...
public class AudioEncoder {
    ...
    private static AudioEncoder createAudioEncoder16() {
        ...
        try {
                ...
                if (codecInfo.isEncoder()) {
                    ...
                    for (int i$ = 0; i$ < len$; ++i$) {
                        ...
                        if (supportedMime.equals("audio/mp4a-latm")) {
                            ...
                            if (null == cap) {
                                LLog.e("AudioEncoder", "AudioEncoder16: failed to get aac codec capabilities");
                                return null;
                            }

                            MediaCodec encoder = MediaCodec.createEncoderByType("audio/mp4a-latm");
                            if (null == encoder) {
                                LLog.e("AudioEncoder", "AudioEncoder16: failed to create aac encoder");
                                return null;
                            }

                            MediaFormat format = MediaFormat.createAudioFormat("audio/mp4a-latm", '\uac44', 1);
                            if (null == format) {
                                LLog.e("AudioEncoder", "AudioEncoder16: failed to create audio format");
                                encoder.release();
                                return null;
                            }
            ...
            LLog.e("AudioEncoder", Log.getStackTraceString(var11));
            return null;
        }
    }
    ...
    private static AudioEncoder createAudioEncoder18() {
        ...
        try {
            ...
            if (null == e) {
                LLog.e("AudioEncoder", "AudioEncoder18: failed to create aac encoder");
                return null;
            }

            MediaCodecInfo info = e.getCodecInfo();
            if (null == info) {
                LLog.e("AudioEncoder", "AudioEncoder18: failed to get aac codec info");
                e.release();
                return null;
            }
            ...
            if (null == cap) {
                LLog.e("AudioEncoder", "AudioEncoder18: failed to get aac codec capabilities");
                e.release();
                return null;
            }
            ...
            if (null == audioFormat) {
                LLog.e("AudioEncoder", "AudioEncoder18: failed to create audio format");
                e.release();
                return null;
            }
            ...
            LLog.e("AudioEncoder", Log.getStackTraceString(var5));
        }
