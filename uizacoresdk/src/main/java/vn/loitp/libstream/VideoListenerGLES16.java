...
import vn.loitp.libstream.gles.EglCore;
import vn.loitp.libstream.gles.FullFrameRect;
import vn.loitp.libstream.gles.FullFrameRect2;
import vn.loitp.libstream.gles.Texture2dProgram;
import vn.loitp.libstream.gles.WindowSurface;

@TargetApi(18)
class VideoListenerGLES16 extends VideoListener16Base implements OnFrameAvailableListener {

    private static final String TAG = VideoListenerGLES16.class.getSimpleName();
