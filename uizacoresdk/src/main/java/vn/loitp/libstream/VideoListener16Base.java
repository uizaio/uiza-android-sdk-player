...
abstract class VideoListener16Base extends VideoListener {
    ...
    protected void getVideoFrame() {
        try {
            if (null == this.encoder_.getEncoder()) {
                LLog.e("VideoListener16Base", "video codec is null");
            } else if (null == this.bufferInfo) {
                LLog.e("VideoListener16Base", "bufferInfo is null");
            } else {
                while (true) {
                    while (true) {
            ...
            LLog.e("VideoListener16Base", "failed to get video frame from encoder");
            LLog.e("VideoListener16Base", Log.getStackTraceString(var4));
        }
    }
    ...
    public Parameters getCameraParameters() {
        if (this.mCamera == null) {
            LLog.d("VideoListener16Base", "mCamera is null");
            return null;
        } else {
