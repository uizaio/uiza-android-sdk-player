...
abstract class VideoListener {
        ...
        if (VERSION.SDK_INT >= 21) {
            this.mediaCodecCallback = new Callback() {
                ...
                public void onError(MediaCodec codec, CodecException e) {
                    LLog.e("VideoListener", "onError");
                    LLog.e("VideoListener", Log.getStackTraceString(e));
                    VideoListener.this.setVideoCaptureState(Streamer.CAPTURE_STATE.FAILED);
                }

                @TargetApi(21)
                public void onOutputFormatChanged(MediaCodec codec, MediaFormat format) {
                    LLog.d("VideoListener", "onOutputFormatChanged");
    ...
    protected void setVideoCaptureState(final Streamer.CAPTURE_STATE videoCaptureState) {
    ...
    protected void processOutputFormatChanged(MediaFormat format) {
        LLog.d("VideoListener", "processOutputFormatChanged");
