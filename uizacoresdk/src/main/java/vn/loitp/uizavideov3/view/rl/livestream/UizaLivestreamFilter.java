...
public class UizaLivestreamFilter extends RelativeLayout implements ConnectCheckerRtmp, SurfaceHolder.Callback {
    ...
    public UizaLivestreamFilter(Context context) {
        super(context);
        onCreate();
    }

    public UizaLivestreamFilter(Context context, AttributeSet attrs) {
        super(context, attrs);
        onCreate();
    }

    public UizaLivestreamFilter(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        onCreate();
    }

    public UizaLivestreamFilter(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
