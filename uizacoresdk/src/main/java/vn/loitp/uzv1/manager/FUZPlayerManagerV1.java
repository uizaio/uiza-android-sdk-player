...
import vn.loitp.uzv1.view.floatview.FUZVideoV1;

/**
 * Manages the {@link ExoPlayer}, the IMA plugin and all video playback.
 */
/* package */ public final class FUZPlayerManagerV1 implements AdsMediaSource.MediaSourceFactory {
    ...
    public FUZPlayerManagerV1(final FUZVideoV1 uizaIMAVideo, String linkPlay, String urlIMAAd, String thumbnailsUrl, List<Subtitle> subtitleList) {
        this.context = uizaIMAVideo.getContext();
        this.FUZVideoV1 = uizaIMAVideo;
    ...
    public void init() {
        ...
        FUZVideoV1.getPlayerView().setPlayer(player);
    ...
    private MediaSource createMediaSourceWithAds(MediaSource mediaSource) {
        ...
        MediaSource mediaSourceWithAds = new AdsMediaSource(
                ...
                this,
                adsLoader,
                FUZVideoV1.getPlayerView().getOverlayFrameLayout(),
                null,
                null);
    ...
    private void hideProgress() {
        LUIUtil.hideProgressBar(FUZVideoV1.getProgressBar());
    }

    private void showProgress() {
        LUIUtil.showProgressBar(FUZVideoV1.getProgressBar());
    }
