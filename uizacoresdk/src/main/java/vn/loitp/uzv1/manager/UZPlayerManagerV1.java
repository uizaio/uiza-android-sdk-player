 ...
 */
/* package */ public final class UZPlayerManagerV1 implements AdsMediaSource.MediaSourceFactory, PreviewLoader {
    ...
    public UZPlayerManagerV1(final UZVideoV1 UZVideoV1, String linkPlay, String urlIMAAd, String thumbnailsUrl, List<Subtitle> subtitleList) {
        this.mls = 0;
        this.context = UZVideoV1.getContext();
        this.UZVideoV1 = UZVideoV1;
        ...
        //SETUP ORTHER
        this.imageView = UZVideoV1.getIvThumbnail();
        this.previewTimeBar = UZVideoV1.getPreviewTimeBar();
    ...
    public void setRunnable() {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (UZVideoV1.getPlayerView() != null) {
        ...
        UZVideoV1.getPlayerView().setControllerShowTimeoutMs(0);
    }
    ...
    public void init() {
        ...
        UZVideoV1.getPlayerView().setPlayer(player);
        ...
        if (UZVideoV1.getDebugTextView() != null) {
            debugTextViewHelper = new DebugTextViewHelper(player, UZVideoV1.getDebugTextView());
    ...
    private MediaSource createMediaSourceWithAds(MediaSource mediaSource) {
        ...
        MediaSource mediaSourceWithAds = new AdsMediaSource(
                ...
                this,
                adsLoader,
                UZVideoV1.getPlayerView().getOverlayFrameLayout(),
                null,
                null);
    ...
    private void hideProgress() {
        LUIUtil.hideProgressBar(UZVideoV1.getProgressBar());
    }

    private void showProgress() {
        LUIUtil.showProgressBar(UZVideoV1.getProgressBar());
    }
    ...
    public class VideoEventListener implements VideoRendererEventListener {
        ...
        public void onRenderedFirstFrame(Surface surface) {
            ...
            UZVideoV1.removeVideoCover(false);
        }
