package vn.loitp.uzv1.view.floatview;
...
public class FUZVideoServiceV1 extends Service implements FUZVideoV1.Callback {
    ...
    public void onCreate() {
        ...
        FUZVideoV1 = (FUZVideoV1) mFloatingView.findViewById(R.id.uiza_video);
    ...
    private void setListener() {
        ...
        if (FUZVideoV1 == null || FUZVideoV1.getPlayer() == null) {
            return;
        }
        FUZVideoV1.getPlayer().addListener(new Player.EventListener() {
            @Override
        ...
        FUZVideoV1.getPlayer().addAudioDebugListener(new AudioRendererEventListener() {
            @Override
        ...
        FUZVideoV1.setProgressCallback(new ProgressCallback() {
            @Override
        ...
        FUZVideoV1.getPlayer().addVideoDebugListener(new VideoRendererEventListener() {
            @Override
        ...
        FUZVideoV1.getPlayer().addMetadataOutput(new MetadataOutput() {
            @Override
            public void onMetadata(Metadata metadata) {
                //LLog.d(TAG, "onMetadata");
            }
        });
        FUZVideoV1.getPlayer().addTextOutput(new TextOutput() {
            @Override
    ...
    public void onMessageEvent(ComunicateMng.MsgFromActivity msg) {
        ...
        if (msg instanceof ComunicateMng.MsgFromActivityPosition) {
            ...
            if (FUZVideoV1 != null) {
                FUZVideoV1.seekTo(((ComunicateMng.MsgFromActivityPosition) msg).getPosition());
            }
            ...
            if (FUZVideoV1 != null) {
                ...
                msgFromServicePosition.setPosition(FUZVideoV1.getCurrentPosition());
