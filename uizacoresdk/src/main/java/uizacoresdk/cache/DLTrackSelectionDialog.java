 ...
 */
public final class DLTrackSelectionDialog extends DialogFragment {
     ...
     *                          dismissed.
     */
    public static DLTrackSelectionDialog createForTrackSelector(
        ...
        final DLTrackSelectionDialog trackSelectionDialog = new DLTrackSelectionDialog();
     ...
     *                                dismissed.
     */
    public static DLTrackSelectionDialog createForMappedTrackInfoAndParameters(
            int titleId,
        ...
        DLTrackSelectionDialog trackSelectionDialog = new DLTrackSelectionDialog();
        trackSelectionDialog.init(
                titleId,
                mappedTrackInfo,
                initialParameters,
    ...
    public View onCreateView(
        ...
        View dialogView = inflater.inflate(R.layout.download_track_selection_dialog, container, false);
