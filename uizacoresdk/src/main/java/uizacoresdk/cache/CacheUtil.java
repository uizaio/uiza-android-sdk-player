...
public class CacheUtil {
    ...
    protected void setDatabaseProvider(DatabaseProvider provider) {
    ...
    protected void setMaxBytes(long maxBytes) {
     ...
     */
    protected void setSecretKey(byte[] secretKey) {
    ...
    public synchronized Cache getCache() {
        if (cache == null) {
            ...
            cache = new SimpleCache(cacheContentDirectory, evictor,
                    databaseProvider, secretKey,
