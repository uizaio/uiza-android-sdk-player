 ...
 */
public class UizaTrackSelectionView extends LinearLayout {
    ...
    public static Pair<AlertDialog, UizaTrackSelectionView> getDialog(
        ...
        final UizaTrackSelectionView selectionView = dialogView.findViewById(R.id.uz_track_selection_view);
    ...
    private List<UizaItem> uzItemList = new ArrayList<>();

    public List<UizaItem> getUZItemList() {
        return uzItemList;
    }
    ...
    public UizaTrackSelectionView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        componentListener = new UizaTrackSelectionView.ComponentListener();
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                UizaItem uzItem = new UizaItem();
                uzItem.setCheckedTextView(trackView);
                uzItem.setDescription(trackView.getText().toString());
                uzItem.setFormat(UizaUtil.getFormatVideo(trackView.getText().toString()));
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            UizaTrackSelectionView.this.onClick(view);
        }
    }
