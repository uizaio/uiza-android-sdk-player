...
public class UizaVideoInfoView extends RelativeLayout {
    ...
    public UizaVideoInfoView(Context context) {
        super(context);
        onCreate();
    }

    public UizaVideoInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        onCreate();
    }

    public UizaVideoInfoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        onCreate();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public UizaVideoInfoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
