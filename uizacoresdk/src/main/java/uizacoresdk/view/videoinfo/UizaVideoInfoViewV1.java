...
import uizacoresdk.util.UizaDataV1;
...
public class UizaVideoInfoViewV1 extends RelativeLayout {
    ...
    public UizaVideoInfoViewV1(Context context) {
        super(context);
        onCreate();
    }

    public UizaVideoInfoViewV1(Context context, AttributeSet attrs) {
        super(context, attrs);
        onCreate();
    }

    public UizaVideoInfoViewV1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        onCreate();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public UizaVideoInfoViewV1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void findViews() {
        ...
        mAdapter = new ItemAdapterV1(itemList, sizeW, sizeH, new ItemAdapterV1.Callback() {
            @Override
