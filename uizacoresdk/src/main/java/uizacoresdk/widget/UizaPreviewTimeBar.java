...
import uizacoresdk.widget.previewseekbar.PreviewDelegate;
import uizacoresdk.widget.previewseekbar.PreviewLoader;
import uizacoresdk.widget.previewseekbar.PreviewView;


public class UizaPreviewTimeBar extends DefaultTimeBar implements PreviewView,
    ...
    public UizaPreviewTimeBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.UizaPreviewTimeBar, 0, 0);
        frameLayoutId = a.getResourceId(R.styleable.UizaPreviewTimeBar_previewFrameLayout, View.NO_ID);
    }
