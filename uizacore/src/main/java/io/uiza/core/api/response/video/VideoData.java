...
public class VideoData {
    ...
    @Expose
    private List<PublishSocial> linkPublishSocial;
    ...
    public List<PublishSocial> getLinkPublishSocial() {
        return linkPublishSocial;
    }

    public void setLinkPublishSocial(List<PublishSocial> linkPublishSocial) {
