...
package io.uiza.core.view.seekbar;
...
public class UzVerticalSeekBarWrapper extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ((seekBar != null) && (widthMode != MeasureSpec.EXACTLY)) {
            ...
            final int hPadding = getPaddingLeft() + getPaddingRight();
            final int vPadding = getPaddingTop() + getPaddingBottom();
            final int innerContentWidthMeasureSpec = MeasureSpec
                    .makeMeasureSpec(Math.max(0, widthSize - hPadding), widthMode);
            final int innerContentHeightMeasureSpec = MeasureSpec
                    .makeMeasureSpec(Math.max(0, heightSize - vPadding), heightMode);
            ...
            final int measuredWidth = ViewCompat
                    .resolveSizeAndState(seekBarWidth + hPadding, widthMeasureSpec, 0);
            final int measuredHeight = ViewCompat
