...
@PrepareForTest({
        ...
        UzRestClientTracking.class, UzPlayerUtil.class, UzCoreUtil.class, UzOsUtil.class, TmpParamData.class,
...
public class UZVideoDataTest {
    ...
    public void setup() {
        PowerMockito.mockStatic(UzRestClient.class, UzRestClientGetLinkPlay.class,
                UzRestClientHeartBeat.class, UzRestClientTracking.class, UzPlayerUtil.class, UzCoreUtil.class,
    ...
    public void initSDK_DEV_success() {
        ...
        UzPlayerData.getInstance().initUzSdk(API_VERSION_3, domain, token, appId, Constants.ENVIRONMENT_DEV);
        ...
        UzPlayerData.setToken(any(Context.class), anyString());
        ...
        UzPlayerData.setApiTrackEndPoint(any(Context.class), anyString());
    }
    ...
    public void initSDK_STG_success() {
        ...
        UzPlayerData.getInstance().initUzSdk(API_VERSION_3, domain, token, appId, Constants.ENVIRONMENT_STAG);
    ...
    public void initSDK_PRO_success() {
        ...
        UzPlayerData.getInstance().initUzSdk(API_VERSION_3, domain, token, appId, Constants.ENVIRONMENT_PROD);
    ...
    public void initSDK_wrongDomain_failed() {
        ...
        for (String domain : invalidDomains) {
            assertFalse(UzPlayerData.getInstance()
                    .initUzSdk(API_VERSION_3, domain, token, appId, Constants.ENVIRONMENT_PROD));
        }
    }
    ...
    public void createTrackingInput_Success() {
        ...
        when(UzPlayerData.getInstance()
                .createTrackingInput(mockContext, playThrough, eventType)).thenCallRealMethod();
        UizaTracking uizaTracking =
                UzPlayerData.getInstance().createTrackingInput(mockContext, playThrough, eventType);
