...
public final class SpeedDialog extends Dialog implements View.OnClickListener {
    ...
    public SpeedDialog(Context context, float currentSpeed, Callback callback) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Speed speed0 = new Speed(SPEED_025, 0.25f);
        final Speed speed1 = new Speed(SPEED_050, 0.5f);
        final Speed speed2 = new Speed(SPEED_075, 0.75f);
        final Speed speed3 = new Speed(SPEED_100, 1f);
        final Speed speed4 = new Speed(SPEED_125, 1.25f);
        final Speed speed5 = new Speed(SPEED_150, 1.5f);
        final Speed speed6 = new Speed(SPEED_200, 2f);
    ...
    public void onClick(View view) {
        ...
        UzCommonUtil.actionWithDelayed(200, new DelayCallback() {
            @Override
