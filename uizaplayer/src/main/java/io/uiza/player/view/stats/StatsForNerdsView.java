...
public class StatsForNerdsView extends RelativeLayout {
    ...
    private TextView textEntityId, textBufferHealth, textNetworkActivity, textVolume,
            textViewPortFrame, textConnectionSpeed, textHost, textVersion, textDeviceInfo,
            textVideoFormat, textAudioFormat, textResolution, textLiveStreamLatency,
            textLiveStreamLatencyTitle;
    ...
    private void init() {
        ...
        findViewById(R.id.btn_close).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                UzDisplayUtil.goneViews(StatsForNerdsView.this);
            }
        });
    }
     ...
     * Depict Entity id.
     *
     * @param value should be formatted like below EX: c62a5409-0e8a-4b11-8e0d-c58c43d81b60
     */
     ...
     *
     * @param value should be formatted like below EX: 20 s
     */
     ...
     *
     * @param value should be formatted like below EX: 5 kB or 5 MB
     */
     ...
     * Depict Volume.
     *
     * @param value should be formatted like below EX: 50%
     */
     ...
     *
     * @param value should be formatted like below EX: 806x453 / 0 dropped frames
     */
     ...
     *
     * @param value should be formatted like below EX: 40 mbps or 40 kbps
     */
     ...
     * Depict host.
     *
     * @param value should be formatted like below EX: https://uiza.io
     */
     ...
     * Depict version.
     *
     * @param value should be formatted like below EX: SDK Version / Player Version / API Version
     */
     ...
     * Depict Device Info.
     *
     * @param value should be formatted like below EX: Device Name / OS Version
     */
     ...
     * Depict Video format.
     *
     * @param value should be formatted like below Ex: video/avc 1280x720@30
     */
     ...
     * Depict audio format.
     *
     * @param value should be formatted like below Ex: audio/mp4a-latm 48000Hz
     */
     ...
     *
     * @param value should be formatted like below Ex: 1280x720 /
     */
     ...
     *
     * @param value should be formatted like below Ex: 1000 ms /
     */
    public void setTextLiveStreamLatency(String value) {
        textLiveStreamLatency
                .setText(getContext().getString(R.string.format_live_stream_latency, value));
    }
    ...
    public void hideTextLiveStreamLatency() {
        UzDisplayUtil.goneViews(textLiveStreamLatency, textLiveStreamLatencyTitle);
    }
    ...
    public void showTextLiveStreamLatency() {
        UzDisplayUtil.visibleViews(textLiveStreamLatency, textLiveStreamLatencyTitle);
    }
}
