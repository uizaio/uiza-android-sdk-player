...
public class UzTrackSelectionView extends LinearLayout {
    ...
    public UzTrackSelectionView(Context context, @Nullable AttributeSet attrs,
        ...
        UzTrackItem uzTrackItemDisableView = new UzTrackItem();
        uzTrackItemDisableView.setCheckedTextView(disableView);
        uzTrackItemDisableView.setDescription(disableView.getText().toString());
        uzTrackItemDisableView.setFormat(new UzTrackItem.Format());
        uzTrackItemList.add(uzTrackItemDisableView);

        UzTrackItem uzTrackItemDefaultView = new UzTrackItem();
        uzTrackItemDefaultView.setCheckedTextView(defaultView);
        uzTrackItemDefaultView.setDescription(defaultView.getText().toString());
        uzTrackItemDefaultView.setFormat(new UzTrackItem.Format());
        uzTrackItemList.add(uzTrackItemDefaultView);
    }

    private List<UzTrackItem> uzTrackItemList = new ArrayList<>();

    public List<UzTrackItem> getUzTracks() {
        return uzTrackItemList;
    }
     ...
     * will be shown by it.
     */
    public static Pair<AlertDialog, UzTrackSelectionView> getDialog(Context context,
            CharSequence title, DefaultTrackSelector trackSelector, int rendererIndex) {
    ...
    private void updateViews() {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                UzTrackItem uzTrackItem = new UzTrackItem();
                uzTrackItem.setCheckedTextView(trackView);
                uzTrackItem.setDescription(trackView.getText().toString());
                uzTrackItem.setFormat(UzPlayerUtil.getFormatVideo(trackView.getText().toString()));
                uzTrackItemList.add(uzTrackItem);
            }
        }
        updateViewStates();
    }
