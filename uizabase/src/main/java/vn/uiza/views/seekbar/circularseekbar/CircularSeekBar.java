package vn.uiza.views.seekbar.circularseekbar;
...
public class CircularSeekBar extends View {
    ...
    private @Nullable
    OnCircularSeekBarChangeListener mOnCircularSeekBarChangeListener = null;
    private @Nullable
    OnCenterClickedListener mOnCenterClickedListener = null;
    ...
    float mRingWidthFactor = 0.5f;
    private @Nullable
    String mProgressText = null;
    private boolean mShowInnerCircle = true;
    private @ColorInt
    int mRingColor = Color.rgb(192, 255, 140); //LIGHT LIME
    private @ColorInt
    int mInnerCircleColor = Color.WHITE;
    private @ColorInt
    int mProgressTextColor = Color.BLACK;
    private @FloatRange(from = 0)
    float mProgressTextSize = Utils.convertDpToPixel(getResources(), 24f);
    ...
    private @FloatRange(from = 0, to = 360)
    float mTouchAngle = 0f;
