package vn.uiza.views.wwlvideo.layout;
...
import vn.uiza.R;
import vn.uiza.views.wwlvideo.utils.WWLIllegal;
import vn.uiza.views.wwlvideo.utils.WWLViewHelper;
...
public class WWLVideo extends ViewGroup {
    ...
    static final class MParcelable extends BaseSavedState {
    ...
    final class PlayerViewClickListener implements OnClickListener {
