...
public class FakeData {
    ...
    public static ResultTimeStartLive resultTimeStartLive() {
        ResultTimeStartLive timeStartLive = new ResultTimeStartLive();
        Data data = new Data();
        data.setEncode(0);
        data.setStatus(0);
    ...
    public static ResultGetListSkin resultGetListSkin() {
        ResultGetListSkin listSkin = new ResultGetListSkin();
        listSkin.setData(new ArrayList<Datum>());
