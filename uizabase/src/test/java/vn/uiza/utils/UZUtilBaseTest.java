...
public class UZUtilBaseTest {
    ...
    public void test_getDetailEntity_success_with_data() {
        ...
        // When
        PowerMockito.when(UZRestClient.createService(UZService.class)).thenReturn(Mockito.mock(UZService.class));
        PowerMockito.when(UZAPIMaster.getInstance()).thenReturn(Mockito.mock(UZAPIMaster.class));

        // Given
        UZUtilBase.getDetailEntity(context, entityId, callbackGetDetailEntity);
    ...
    public void test_getDetailEntity_success_wrongData_then_getDataFromEntityIdLIVE() {
        ...
        UZUtilBase.getDataFromEntityIdLIVE(context, entityId, callbackGetDetailEntity);
    }
